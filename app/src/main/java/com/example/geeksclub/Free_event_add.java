...
public class Free_event_add extends AppCompatActivity {
        ...
        StringRequest request=new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                if(response.equalsIgnoreCase("Records inserted successfully.")){
                    Toast.makeText(Free_event_add.this, " Event Created", Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();}

                else{
                    Toast.makeText(Free_event_add.this, ""+response, Toast.LENGTH_SHORT).show();
                    progressDialog.dismiss();}
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Free_event_add.this, ""+error.getMessage(), Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
            }
        }){
            @Override
